...
public class CircleDisplay {
  ...
  Vector2 velocity;
  TextureRegion tex;
  public TextureRegion[] texNumber = new TextureRegion[2];
  ...
  public CircleDisplay(float r, TextureRegion tex) {
    this(0, 0, r, tex);
  }

  public CircleDisplay(float px, float py, float r, TextureRegion tex) {
    this(px, py, r, 0, 0, tex);
  }

  public CircleDisplay(float px, float py, float r, float vx, float vy,
      TextureRegion tex) {
  ...
  public void draw(Plane plane) {
    if (tex != null) {
      ...
      plane.draw(texNumber[0], this.position.x - this.radius + 2,
          this.position.y - this.radius, this.radius, 2 * this.radius,
          this.rotation);
      plane.draw(texNumber[1], this.position.x - 2, this.position.y
          - this.radius, this.radius, 2 * this.radius, this.rotation);
      // plane.draw(texNumber[1], this.position.x,
      // this.position.y, this.radius, 0f, this.radius,
  ...
  public static boolean collides(CircleDisplay circle1, CircleDisplay circle2) {
  ...
  public static boolean collidesInner(CircleDisplay circle1,
      CircleDisplay circle2Inner) {
  ...
  public static void checkCollOutter(CircleDisplay bigCircle,
      CircleDisplay circle1) {
    if (CircleDisplay.collides(bigCircle, circle1)) {
      circle1.normalV = 0;
      circle1.flag = true;
