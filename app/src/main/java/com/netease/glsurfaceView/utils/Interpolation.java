...
public abstract class Interpolation {
  ...
  static public final Interpolation fade = new Interpolation() {
    @Override
    public float apply(float a) {
      return NumberUtils.clamp(a * a * a * (a * (a * 6 - 15) + 10), 0, 1);
    }
  };
  ...
  static public class Pow extends Interpolation {
    ...
    public float apply(float a) {
      ...
      return (float) Math.pow((a - 1) * 2, power) / (power % 2 == 0 ? -2 : 2)
          + 1;
    }
  }
  ...
  static public class Elastic extends Interpolation {
    ...
    public float apply(float a) {
      if (a <= 0.5f) {
        a *= 2;
        return (float) (Math.pow(value, power * (a - 1)) * Math.sin(a * 20)
            * 1.0955f / 2);
      }
      a = 1 - a;
      a *= 2;
      return 1 - (float) (Math.pow(value, power * (a - 1)) * Math.sin((a) * 20)
          * 1.0955f / 2);
    }
  }
  ...
  static public class ElasticIn extends Elastic {
    ...
    @Override
    public float apply(float a) {
      return (float) (Math.pow(value, power * (a - 1)) * Math.sin(a * 20) * 1.0955f);
    }
  }
  ...
  static public class ElasticOut extends Elastic {
    ...
    public float apply(float a) {
      a = 1 - a;
      return (1 - (float) (Math.pow(value, power * (a - 1)) * Math.sin(a * 20) * 1.0955f));
    }
  }
  ...
  static public class BounceOut extends Interpolation {
    ...
    public BounceOut(int bounces) {
      if (bounces < 2 || bounces > 5) {
        throw new IllegalArgumentException("bounces cannot be < 2 or > 5: "
            + bounces);
      }
  ...
  public static Interpolation getInterpolation(String interPolationType) {
    try {
      return (Interpolation) Interpolation.class.getField(interPolationType)
          .get(null);
    } catch (Exception ex) {
